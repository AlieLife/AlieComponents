...
var Calendar = function (_React$Component) {
    ...
    _createClass(Calendar, [{
        ...
        value: function componentDidMount() {
            ...
            (0, _jquery2.default)(".calendarBoxWrapper").hover(function (event) {
                if (!_iconState) {
                    (0, _jquery2.default)(".calendarIcon").removeClass("anticon-calendar").addClass("anticon-cross-circle");
                    (0, _jquery2.default)(".calendarIcon").css("cursor", "pointer");
                }
            }, function (event) {
                (0, _jquery2.default)(".calendarIcon").addClass("anticon-calendar").removeClass("anticon-cross-circle");
                (0, _jquery2.default)(".calendarIcon").css("cursor", "initial");
            });
        }
    }, {
        ...
        value: function render() {
            ...
            if (this.state.isShowPan) {
                html = _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { ref: 'cInput', className: 'calendarInput canClicked', placeholder: this.state.placeholder, value: this.state.selectedDay, onChange: function onChange(e) {
